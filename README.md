...
Due to file storage memory issues, the following images were uploaded on our page in the NITRC website.  

https://www.nitrc.org/projects/arterialatlas

We highly recommend downloading all other probability maps from NITRC. 
